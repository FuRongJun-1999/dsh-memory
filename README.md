...
| 基准 | 归属 | 状态 |
|---|---|---|
| LongMemEval-S | 第三方 `xiaowu0162/LongMemEval`（500 题 / 189635 turns） | 数据集已本地化；**我方成绩未产出** |
| LoCoMo | 第三方 `mteb/LoCoMo` BEIR（1976 题 / 5882 turns） | 数据集已本地化；**我方成绩未产出** |
| memory-bench-1000 | **自建**（唯一我方成绩） | SNR 见评分报告 v2.0；已公开 `data/memory-bench-1000.jsonl` |

> LongMemEval-S / LoCoMo 为**第三方公开对标基准，非本仓库成绩**；未经协议化复跑，本仓库不声明其上的我方成绩。
